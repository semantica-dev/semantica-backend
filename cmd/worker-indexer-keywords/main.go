...
func main() {
	...
	serviceName := "worker-indexer-keywords-service"
	...
	// TODO: Инициализация PostgreSQL клиента
	...
	service := indexerkeywords.NewIndexerKeywordsService(appLogger, rmqClient, minioClient /*, dbClient */)
